...
export const KpiCard = ({
  ...
  const themes = {
    ...
    danger: {
      icon: "bg-rose-50 text-rose-500 ring-1 ring-rose-200",
      bar: "bg-rose-400",
    },
    info: {
      icon: "bg-indigo-50 text-indigo-600 ring-1 ring-indigo-200",
      bar: "bg-indigo-400",
    },
    warning: {
      icon: "bg-amber-50 text-amber-600 ring-1 ring-amber-200",
      bar: "bg-amber-300",
    },
  };
  ...
  return (
    <Card className="relative overflow-hidden">
      ...
      <div>
        ...
        <h3
          className={cn(
            "text-slate-900 font-black tabular-nums tracking-tight whitespace-nowrap",
            valueSize,
          )}
        >
          {value}
