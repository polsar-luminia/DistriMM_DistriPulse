    ...
    >
      <div className="bg-white rounded-2xl max-w-lg w-full overflow-hidden shadow-2xl">
        <div className="relative h-56 bg-gray-50">
          ...
          <button
            onClick={onClose}
            className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/90 flex items-center justify-center font-bold text-gray-600 hover:bg-white transition-colors text-lg"
          >
            ×
          </button>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-2xl font-black" style={{ color: 'var(--green-deep)' }}>{formatCOP(producto.precio)}</p>
            </div>
