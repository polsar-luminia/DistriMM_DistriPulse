...
BEGIN
  ...
  SELECT
    ...
    COALESCE(NULLIF(r->>'valor_recaudo', '')::NUMERIC, 0),
    COALESCE(NULLIF(r->>'valor_excluido_marca', '')::NUMERIC, 0),
    COALESCE(NULLIF(r->>'valor_iva', '')::NUMERIC, 0),
    COALESCE(NULLIF(r->>'dias_mora', '')::INT, 0),
